...
@Component({
  selector: 'app-bug-detail-screen',
  templateUrl: './bug-detail-screen.component.html',
  styleUrl: './bug-detail-screen.component.scss',
})
export class BugDetailScreenComponent
