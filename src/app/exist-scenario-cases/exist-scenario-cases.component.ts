...
@Component({
  selector: 'app-exist-scenario-cases',
  templateUrl: './exist-scenario-cases.component.html',
  styleUrl: './exist-scenario-cases.component.scss',
  providers: [{ provide: MAT_DATE_LOCALE, useValue: "en-GB" }],
})
export class ExistScenarioCasesComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    public advanceTableService: ExistScenarioCasesService,
  ...
  public loadData() {
    this.exampleDatabase = new ExistScenarioCasesService(this.httpClient);
...
export class ExampleDataSource extends DataSource<AdvanceTable> {
  ...
  constructor(
    public exampleDatabase: ExistScenarioCasesService,
