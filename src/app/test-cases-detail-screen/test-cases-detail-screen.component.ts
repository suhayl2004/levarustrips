...
@Component({
  selector: "app-test-cases-detail-screen",
  templateUrl: "./test-cases-detail-screen.component.html",
  styleUrl: "./test-cases-detail-screen.component.scss",
})
export class TestCasesDetailScreenComponent
