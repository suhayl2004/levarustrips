...
import { AdvanceTable } from "./tsc-table.model";
import { TscTableService } from "./tsc-table.service";

@Component({
  selector: 'app-tsc-table',
  templateUrl: './tsc-table.component.html',
  styleUrl: './tsc-table.component.scss',
  providers: [{ provide: MAT_DATE_LOCALE, useValue: "en-GB" }],
})
export class TscTableComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  constructor(
    ...
    public advanceTableService: TscTableService,
  ...
  public loadData() {
    this.exampleDatabase = new TscTableService(this.httpClient);
...
export class ExampleDataSource extends DataSource<AdvanceTable> {
  ...
  constructor(
    public exampleDatabase: TscTableService,
