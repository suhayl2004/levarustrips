...
import { ExampleDataSource, ExistScenarioCasesComponent } from "app/exist-scenario-cases/exist-scenario-cases.component";
...
@Component({
  selector: "app-test-scenarios-detail-form",
  templateUrl: "./test-scenarios-detail-form.component.html",
  styleUrl: "./test-scenarios-detail-form.component.scss",
  providers: [{ provide: MAT_DATE_LOCALE, useValue: "en-GB" }],
})
export class TestScenariosDetailFormComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<TestScenariosDetailFormComponent>,
  ...
  ngOnInit(): void {
    ...
    if (this.action === "add") {
      this.advanceTableForm = this.fb.group({
        ...
        pconditions: [this.advanceTable.pconditions],
        comments: [
  ...
  @ViewChild(ExistScenarioCasesComponent) existScenarioCasesComponent!: ExistScenarioCasesComponent;


  public confirmExistAdd(): void {
  ...
  public confirmExistAddnew(): void {
    console.log(this.advanceTableForm.value);
    const formValue = this.advanceTableForm.value;
    const relevantData = {
      id: formValue.id,
