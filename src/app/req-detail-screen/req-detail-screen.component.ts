...
@Component({
  selector: "app-req-detail-screen",
  templateUrl: "./req-detail-screen.component.html",
  styleUrl: "./req-detail-screen.component.scss",
})
export class ReqDetailScreenComponent
